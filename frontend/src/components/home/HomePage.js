    ...
    <div>
      ...
      <div id="home-page">
        ...
        <div class="hero-text">
          ...
          <button class="button" onClick={() => handleAdminClick()}>Admin</button>

        </div>
      </div>

      <div class="info-boxes">
        <InfoBox title="Title" blurb="The Scottish National Trail is an 864 kilometre-long long distance walking route running the length of Scotland from Kirk Yetholm to Cape Wrath.Devised by outdoors writer and broadcaster Cameron McNeish, the Trail offers very varied walking, following long-established footpaths for much of the distance but becoming progressively more difficult as it heads north, finishing with a tough stretch of backpacking - with some pathless and demanding terrain - on the final stretch of the Cape Wrath Trail." pic="./images/map.png"/>
        ...
        <InfoBox title="tytle" blurb="this is a third blurd" pic="./images/map.png"/>
      </div>
